...
export const VIEWER_BRANDING = process.env.REACT_APP_BRANDING || 'default';
...
export const USER_PLACES_COLORS: {[key: string]: Color} = {green, red, blue, yellow, purple, pink, orange, cyan, indigo, grey};
